...
Обновления принимаются только из готового ZIP-asset GitHub Release. Перед установкой проверяются SHA-256, версия, структура архива и наличие runtime-автозагрузчика.
